...
Export-NAVApplicationObject -DatabaseServer 'localhost' -DatabaseName 'Demo Database NAV (11-0)' -Filter 'Type=Page;Id=21..22' -Path 'c:\temp\Al\Objects.txt' -Username 'Admin' -Password '1<3VScode' -ExportToNewSyntax
